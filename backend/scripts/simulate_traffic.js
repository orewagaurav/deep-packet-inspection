...
// Geographically diverse real public IPs so the world map lights up across
// continents (resolved via GeoIP on ingest).
const DEST_IPS = [
  "8.8.8.8",        // US
  "103.21.244.1",   // US (Ashburn)
  "213.186.33.5",   // France (Paris)
  "195.201.201.32", // Germany
  "51.15.0.1",      // Netherlands
  "31.13.64.35",    // Ireland (Dublin)
  "202.12.27.33",   // Japan (Tokyo)
  "77.88.55.60",    // Russia (Moscow)
  "111.221.29.254", // Hong Kong
  "1.1.1.1",        // Australia
  "190.93.240.1",   // Costa Rica
  "196.216.2.1",    // South Africa
];
